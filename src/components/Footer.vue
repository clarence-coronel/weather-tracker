<template>
  <footer class="flex justify-center items-center px-3 py-2">
    <a
      class="group flex justify-center items-center gap-2"
      href="http://www.github.com/clarence-coronel"
      target="_blank"
    >
      <span>Copyright &copy; 2024 Clarence Coronel</span>
      <svg
